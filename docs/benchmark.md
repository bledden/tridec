...
- **One code family carries the LER receipts.** All grid receipts are the
  [[72,12,6]] BB code at 6 rounds under SI1000. The decoders are DEM-agnostic
  by construction (and the surface-code fixture exercises that), but no LER
  receipts exist yet for other codes/distances. TODO: a second code family.
