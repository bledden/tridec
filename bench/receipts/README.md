...
| `surface_relay_metal_preliminary.json` *(in-repo)* | **PRELIMINARY / EXPERIMENTAL** — Relay-BP on surface-code memory via the experimental Metal backend (fp32), 2000 shots/cell, vs plain BP and PyMatching on the same shots. Directional only; official Relay-BP surface receipts are deferred to the Phase-3 CUDA/ROCm session. Generated by `bench/surface_relay_metal.py`. | Apple M4 Max (darwin/arm64), triton 3.7.0 + triton-metal, torch 2.9.1, python 3.14.4 |
